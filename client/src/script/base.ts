...
<div data-tauri-drag-region id='title'
  class='absolute top-0 left-0 right-0 h-6 justify-center text-white text-center align-middle truncate hover:cursor-default'>Vitium</div>
...
`
  ...
  const wrapper = `
<div class='fixed top-6 left-0 right-0 bottom-0 overflow-hidden'></div>
`
